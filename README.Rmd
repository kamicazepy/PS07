...
ggplot(monster_types, aes(x = reorder(monster_type, numberoftimes), y = numberoftimes)) + geom_col() + labs(x = "Type of Monster", y = "Number of times shown", title = "Top 5 types of monsters shown in Scooby Doo episodes", subtitle = "Null data not shown" )+ theme(element_blank())
```
